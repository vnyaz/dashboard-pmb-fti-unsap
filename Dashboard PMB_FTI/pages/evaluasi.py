...
def show_evaluasi():
    ...
    .metric-grid {{ display:grid; grid-template-columns:repeat(4, minmax(0,1fr)); gap:46px; margin-bottom:24px; }}
    ...
    .empty-text {{ color:#52666d; font-size:15px; font-weight:700; line-height:1.45; margin-bottom:18px; }}
    ...
    .interp-card {{ background:white; box-shadow:0 3px 8px rgba(0,0,0,.25); padding:24px 26px 28px; }}
